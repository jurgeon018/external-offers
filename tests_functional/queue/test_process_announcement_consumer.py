...
#     """)
#     client_before = await pg.fetchrow(f"""
...
#     # set_client_unactivated_by_offer_cian_id, set_client_done_by_offer_cian_id и set_offer_done_by_offer_cian_id не отработали
...
#     assert client_after['calls_count'] == client_before['calls_count']
#     assert client_after['calls_count'] != 0
#     assert client_after['next_call'] == None
