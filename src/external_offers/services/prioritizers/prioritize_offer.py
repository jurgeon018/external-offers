...
mapping_offer_categories_to_priority = {
    ...
    Category.domestic_services_rent: RENT_PRIORITY + COMMERCIAL_PRIORITY,
    Category.domestic_services_sale: SALE_PRIORITY + COMMERCIAL_PRIORITY,
    ...
    Category.free_appointment_object_rent: RENT_PRIORITY + COMMERCIAL_PRIORITY,
    Category.free_appointment_object_sale: SALE_PRIORITY + COMMERCIAL_PRIORITY,
