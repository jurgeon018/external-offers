from external_offers.entities import UpdateClientAdditionalNumbersRequest, UpdateClientAdditionalNumbersResponse
from external_offers.repositories.postgresql.clients import get_client_by_client_id, set_additional_numbers_by_client_id
