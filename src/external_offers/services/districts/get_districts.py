...
from external_offers.repositories.monolith_cian_geoapi import v1_get_districts_by_child
from external_offers.repositories.monolith_cian_geoapi.entities import GetDistrictsResponse, V1GetDistrictsByChild
