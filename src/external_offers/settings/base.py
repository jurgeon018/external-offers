...
ENABLE_UPDATED_AT_DATE_FETCHING: bool = True
...
OFFER_TASK_CREATION_REGIONS: List[int] = [4565]
...
NEW_PARSED_OFFERS_COUNT_FOR_DELETE_OLD = 100000

OFFERS_FOR_CALL_FOR_KAFKA_FETCH_LIMIT = 10000
PARSED_OFFERS_FOR_KAFKA_FETCH_LIMIT = 10000
TEAMS_FOR_KAFKA_FETCH_LIMIT = 10000
OPERATORS_FOR_KAFKA_FETCH_LIMIT = 10000
EVENT_LOGS_FOR_KAFKA_FETCH_LIMIT = 10000
CLIENTS_FOR_KAFKA_FETCH_LIMIT = 10000
...
SET_WAITING_OFFERS_PRIORITY_BY_OFFER_IDS_CHUNK = 15000
...
# На проде True
ENABLE_TEAMS_PRIORITIZATION: bool = True

# На проде False
EXCLUDE_CALLTRACKING_FOR_ALL_TEAMS: bool = False
...
CHUNK_SIZE_FOR_PRIORITY_CLIENTS = 1000
ONLY_UNHUNTED_CT_ATTRACTOR_TEAM_ID: list[int] = [143]
