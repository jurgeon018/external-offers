...
SMS_SMB_INSTRUCTION_TEMPLATE: str = '''
Ваше объявление ожидает публикации на Циан:
1)Зайдите в Личный кабинет my.cian.ru
2)В разделе «Сводка» на объявлении с отметкой «В архиве» нажмите «Восстановить» 
2)Отредактируйте объект: проверьте параметры и загрузите фото
3)Выберите тариф за 0 рублей, если он не проставлен автоматически
4)Сохраните изменения
Готово! Ваш объект опубликуется бесплатно
'''
SMS_HOMEOWNER_TEMPLATE: str = '''
Ваше объявление ожидает публикации на Циан:
1)Зайдите в Личный кабинет my.cian.ru в раздел «Мои объявления.beta» и перейдите во вкладку «Неактивные»
2)Отредактируйте объект: проверьте параметры и загрузите фото
3)Выберите тариф за 0 рублей, если он не проставлен автоматически
4)Сохраните изменения
Готово! Ваш объект опубликуется бесплатно
