...
def test_get_next_call_date_when_call_missed__first_call__returns_1_day_later():
    # arrange
    calls_count = 1
...
def test_get_next_call_date_when_call_missed__second_call__returns_no_date():
    # arrange
    calls_count = 2
    now = datetime.now(pytz.utc)
